...
folder_path = "C:\\Users\\copro\\OneDrive\\Masaüstü\\abc"
...
def identify_killer(file_name, content):
    """
    Identifies the potential killer from the document content using GPT-4.
    ...
    Returns:
        str: Analysis result identifying the killer.
    """
    response = openai.ChatCompletion.create(
        model="gpt-4o",  
        messages=[
            {"role": "system", "content": (
                "You are a forensic investigator tasked with identifying the killer based on the given text. "
                "Follow these steps:\n"
                "1. Extract key details from the document, such as suspects, timelines, motives, alibis, and evidence.\n"
                "2. Analyze inconsistencies, motives, and other details to identify the killer.\n"
                "3. Provide a structured response within <Killer> tags for the identified killer "
                "and within <Reasoning> tags for your reasoning."
            )},
